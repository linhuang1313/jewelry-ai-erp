...
export const API_ENDPOINTS = {
  ...
  RECOGNIZE_PAYMENT_PROOF: `${API_BASE_URL}/api/recognize-payment-proof`,
  REGISTER_PAYMENT_FROM_PROOF: `${API_BASE_URL}/api/register-payment-from-proof`,
  // 入库相关
  ...
  TRANSFER_ORDER_DELETE: (id) => `${API_BASE_URL}/api/warehouse/transfer-orders/${id}`,  // 删除转移单
  ...
  INBOUND_DELETE: (id) => `${API_BASE_URL}/api/inbound-orders/${id}`,
  ...
  // 协同卡片
  ACTION_CARDS_PENDING: `${API_BASE_URL}/api/action-cards/pending`,
  ACTION_CARD: (cardId) => `${API_BASE_URL}/api/action-cards/${cardId}`,
  ACTION_CARD_EXECUTE: (cardId) => `${API_BASE_URL}/api/action-cards/${cardId}/execute`,
  NOTIFICATIONS_UNREAD: `${API_BASE_URL}/api/notifications/unread`,
