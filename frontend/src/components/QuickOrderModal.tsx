                  ...
                  <div className="ml-8 mr-2 -mt-1 mb-1 p-3 bg-amber-50 border border-amber-200 rounded-lg text-xs">
                    ...
                    <div className="grid grid-cols-4 gap-x-4 gap-y-1.5 text-gray-600">
                      {[
                        ...
                        { label: '主石单价', field: 'main_stone_price', type: 'number', prefix: '¥', readonly: true },
                        { label: '主石额', field: 'main_stone_amount', type: 'number', prefix: '¥', readonly: true },
                        { label: '副石重', field: 'sub_stone_weight', type: 'number', readonly: true },
                        { label: '副石粒数', field: 'sub_stone_count', type: 'number', readonly: true },
                        { label: '副石单价', field: 'sub_stone_price', type: 'number', prefix: '¥', readonly: true },
                        { label: '副石额', field: 'sub_stone_amount', type: 'number', prefix: '¥', readonly: true },
                        { label: '镶石费', field: 'stone_setting_fee', type: 'number', prefix: '¥', readonly: true },
                        { label: '总金额', field: 'total_amount', type: 'number', prefix: '¥', readonly: true },
