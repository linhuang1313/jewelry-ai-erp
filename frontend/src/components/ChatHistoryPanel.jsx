...
import { History, Search, Calendar, RefreshCw, ChevronRight, MessageSquare, Clock, User, X, Edit2, Pin, Trash2, Check, MoreVertical, ArrowLeft } from 'lucide-react'
      ...
      <div className="relative ml-auto w-full max-w-2xl bg-white shadow-2xl flex flex-col animate-in slide-in-from-right duration-300">
        ...
        <div className="flex-1 overflow-hidden flex">
          {activeTab === 'sessions' ? (
            <>
              {/* 会话列表 */}
              <div className={`${selectedSession ? 'hidden md:block md:w-1/2' : 'w-full'} border-r border-gray-100 overflow-y-auto transition-all`}>
                <div className="p-4">
                            ...
                            <div className="flex items-center gap-1">
                              ...
                              <div className="relative">
                                <button
                                  ...
                                  className="p-1.5 text-gray-400 hover:text-gray-600 hover:bg-gray-200 rounded-lg opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity"
                                >
