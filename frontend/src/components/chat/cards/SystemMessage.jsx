                      ...
                      updated.push({
                        ...
                        transferPrompt: {
                          items: [{
                            ...
                            product_code: card.barcode || '',
                            supplier: card.supplier?.name || '',
                            labor_cost: card.laborCostPerGram || 0,
                            piece_count: card.pieceCount || 0,
                            piece_labor_cost: card.pieceLaborCost || 0,
                            total_cost: card.totalCost || 0,
                          }],
                          status: 'pending',
